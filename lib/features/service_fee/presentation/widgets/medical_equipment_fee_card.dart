...
class MedicalEquipmentFeeCard extends StatelessWidget {
  final MedicalEquipmentDeliveryFee fee;

  const MedicalEquipmentFeeCard({super.key, required this.fee});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                const Icon(Icons.medical_services_outlined, color: AppColors.primaryDark),
