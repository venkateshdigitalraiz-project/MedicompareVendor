    ...
    return Scaffold(
      ...
      body: BlocBuilder<LabTestBloc, LabTestState>(
        builder: (context, state) {
          if (state is LabTestInitial ||
              (state is LabTestLoading &&
                  context.read<LabTestBloc>().state is! LabTestLoaded)) {
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: state.isLoadingMore
                                ? state.labTestResponse.list.length + 1
                                : state.labTestResponse.list.length,
            ...
            builder: (ctx) => Padding(
              ...
              child: ConstrainedBox(
                ...
                child: AddLabTestSheet(
                  existingIds:
                      (context.read<LabTestBloc>().state as LabTestLoaded)
                          .labTestResponse
                          .list
                          .map((m) => m.details.id)
                          .toList(),
      ...
      onDelete: () {
        showDialog(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: Text(
                "Are you sure you want to delete ${item.details.name}? This action cannot be undone.",
                style: GoogleFonts.inter(fontSize: 14)),
            shape:
