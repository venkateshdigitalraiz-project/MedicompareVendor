          ...
          : SingleChildScrollView(
            child: Column(
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          ClipRRect(
                            ...
                            child: Container(
                              ...
                              child: imageUrl.isNotEmpty
                                  ? Image.network(imageUrl, fit: BoxFit.cover, errorBuilder: (c, e, s) => const Icon(Icons.medical_services, size: 30, color: Colors.grey))
                                  : const Icon(Icons.medical_services, size: 30, color: Colors.grey),
                            ),
                          ),
                      ...
                      Wrap(
                        ...
                        runSpacing: 8,
                        children: [
                          _badge(Icons.category_outlined, details.subcategory?.name ?? "N/A", const Color(0xFFE8EEFF), const Color(0xFF506CCF)),
                          _badge(Icons.settings_suggest_outlined, details.procedureType ?? "N/A", const Color(0xFFF3E8FF), const Color(0xFF9333EA)),
                          _badge(Icons.star_outline, details.complexity ?? "Simple", const Color(0xFFE6FFFA), const Color(0xFF0D9488)),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          _infoCard("DURATION", details.duration ?? "N/A", const Color(0xFFE8F1FF), Icons.access_time),
                          const SizedBox(width: 12),
                          _infoCard("RECOVERY", details.recoveryTime ?? "N/A", const Color(0xFFF5EAFC), Icons.healing_outlined),
                        ],
                      ),
                      const SizedBox(height: 12),
                      Row(
                        children: [
                          _infoCard("COMPLEXITY", details.complexity ?? "Simple", const Color(0xFFFFF6E5), Icons.extension_outlined),
                          const SizedBox(width: 12),
                          _infoCard("PROCEDURE", details.procedureType ?? "Simple", const Color(0xFFEAF9F1), Icons.medical_services_outlined),
                        ],
                      ),
                    ],
                  ),
                ...
                if (details.directionOfUse != null && details.directionOfUse!.isNotEmpty)
                  ExpandableHtmlSection(
          ...
          ConstrainedBox(
            ...
            child: ClipRect(
              child: SingleChildScrollView(
                ...
                child: HtmlWidget(
                  widget.htmlContent,
                  textStyle: GoogleFonts.poppins(fontSize: 12, color: const Color(0xFF4B5563), height: 1.6),
                ),
              ),
            ),
          ),
