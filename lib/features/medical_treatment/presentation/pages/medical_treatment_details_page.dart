...
class MedicalTreatmentDetailsPage extends StatefulWidget {
  final MedicalTreatmentItem item;
...
class _MedicalTreatmentDetailsPageState
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    _chip(details.subcategory?.name ?? "General",
  ...
  Widget _buildInfoGrid(MedicalTreatmentDetails details) {
    return Column(
      children: [
        Row(
          children: [
