...
class _HomeCareDetailsPageState extends State<HomeCareDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final double discount = widget.item.price > 0
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      if (discount > 0)
                        _badge(Icons.card_giftcard, "${discount.toInt()}% OFF",
                  ...
                  Row(
                    children: [
                      ...
                      _infoCard("DURATION", details.duration ?? "N/A",
                          const Color(0xFFF5EAFC), Icons.access_time),
                    ],
                  ),
                  const SizedBox(height: 12),
                  Row(
                    children: [
                      _infoCard("MRP", "₹${widget.item.price.toInt()}",
                          const Color(0xFFFFF6E5), Icons.currency_rupee),
                      const SizedBox(width: 12),
                      _infoCard("STATUS", widget.item.status.toUpperCase(),
                          const Color(0xFFEAF9F1), Icons.check_circle_outline),
                    ],
                  ),
                ],
              ),
