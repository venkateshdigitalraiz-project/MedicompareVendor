      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (_, __) => const Scaffold(
              body: Center(child: Text("Step 3: Banking Information"))),
        ),
        GoRoute(
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              MedicineDetailsPage(medicine: state.extra as MedicineItem),
        ),
        GoRoute(
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              SurgeryDetailsPage(surgery: state.extra as SurgeryItem),
        ),
        GoRoute(
          path: '/lab-test-list',
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              LabTestDetailsPage(item: state.extra as LabTestItem),
        ),
        GoRoute(
        ...
        GoRoute(
          ...
          builder: (context, state) => LabTestPackageDetailsPage(
              package: state.extra as LabTestPackageItem),
        ),
        GoRoute(
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              DiagnosticDetailsPage(item: state.extra as DiagnosticItem),
        ),
        GoRoute(
          path: '/homecare-list',
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              HomeCareDetailsPage(item: state.extra as HomeCareItem),
        ),
        GoRoute(
          path: '/nursing-list',
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              NursingCareDetailsPage(item: state.extra as NursingCareItem),
        ),
        GoRoute(
          path: '/dental-list',
        ...
        GoRoute(
          path: '/dental-details',
          builder: (context, state) =>
              DentalServiceDetailsPage(item: state.extra as DentalServiceItem),
        ),
        GoRoute(
        ...
        GoRoute(
          ...
          builder: (context, state) => MedicalTreatmentDetailsPage(
              item: state.extra as MedicalTreatmentItem),
        ),
        GoRoute(
          path: '/equipment-list',
        ...
        GoRoute(
          ...
          builder: (context, state) => MedicalEquipmentDetailsPage(
              item: state.extra as MedicalEquipmentItem),
        ),
        GoRoute(
          path: '/ambulance-list',
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              AmbulanceDetailsPage(ambulance: state.extra as AmbulanceEntity),
        ),
        GoRoute(
          path: '/ambulance-orders',
          builder: (context, state) => BlocProvider(
            create: (_) =>
                AmbulanceOrdersInjection.provideAmbulanceOrdersBloc(),
