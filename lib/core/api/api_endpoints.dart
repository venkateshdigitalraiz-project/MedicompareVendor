class ApiEndpoints {
  ...
  static String surgeryDetails(String id) =>
      '/vendor/product/surgeries/details/$id';
  ...
  static String updateSurgery(String id) =>
      '/vendor/product/surgeries/update/$id';
  static String deleteSurgery(String id) =>
      '/vendor/product/surgeries/delete/$id';
  ...
  static String adminPackageDetails(String id) =>
      "/vendor/admin/package/details/$id";
  ...
  static String diagnosticDetails(String id) =>
      '/vendor/product/diagnostics/details/$id';
  ...
  static String updateDiagnostic(String id) =>
      '/vendor/product/diagnostics/update/$id';
  static String deleteDiagnostic(String id) =>
      '/vendor/product/diagnostics/delete/$id';
  ...
  // Nursing Care (Clinic & Rehabs Services)
  ...
  static const String updateServiceSettings =
      '/vendor/service-charge/updateSettings';
}
